...
class RobotSee():
	...
	def covnvertTOmoves(self, readArray):
		...
		#--- if line is detected nowhere return F(forward) ---
		else:
			return "F"
...
class RobotMove():
	...
	def forward(self):
		self.leftPWM.start(40)
		self.rightPWM.start(40)
	...
	def littleLeft(self):
		self.leftPWM.start(36)
		self.rightPWM.start(36)
		GPIO.output(21, GPIO.LOW)
		GPIO.output(20, GPIO.LOW)
		GPIO.output(12, GPIO.HIGH)
		GPIO.output(13, GPIO.LOW)
	...
	def sharpLeft(self):
		self.leftPWM.start(30)
		self.rightPWM.start(30)
		GPIO.output(21, GPIO.LOW)
